 ...
 * MIT + Commons Clause license — embedding it in this site is permitted;
 * the clause only restricts reselling/redistributing the component itself.
 * Ported to TypeScript; logic left unchanged from the source, only the
 * color defaults are tuned toward the brand palette.
 */
...
export function DotGrid({
    ...
    return (
        <div className={className ?? "relative flex h-full w-full items-center justify-center"}>
